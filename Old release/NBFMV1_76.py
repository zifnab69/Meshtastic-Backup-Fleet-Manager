#!/usr/bin/env python3
"""
Nodes Backup & Fleet Manager v1.76
...
class NBFMApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Nodes Backup & Fleet Manager v1.76")
    ...
    def _build_ui(self):
        ...
        ttk.Label(hdr, text="Nodes Backup & Fleet Manager v1.76",
    ...
    def _build_aide_tab(self, parent, T=None):
        ...
        ttk.Separator(inner, orient="horizontal").pack(fill="x", pady=(10, 4))
        ttk.Label(inner, text="Nodes Backup & Fleet Manager v1.76",
