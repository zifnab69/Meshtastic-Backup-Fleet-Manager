    ...
    "fr": {
        ...
        "help_sections": [
            ...
            ("Éditeur de champs clés", [
                ("p","Modifiez les champs courants d'un NBFM sans éditeur externe."),
                ...
                ("s",(4,"Cliquez Sauvegarder — le fichier NBFM est mis à jour directement.")),
            ]),
        ...
        "edit_psk_hint": "PSK non modifiable ici (utilisez l'app Meshtastic)",
        "edit_cleanup": "Nettoyage avancé v1.7",
    ...
    "en": {
        ...
        "help_sections": [
            ...
            ("Key fields editor", [
                ...
                ("s",(4,"Click Save — the NBFM file is updated directly.")),
            ]),
        ...
        "edit_psk_hint": "PSK cannot be edited here (use the Meshtastic app)",
        "edit_cleanup": "Advanced cleanup v1.7",
...
class NBFMApp:
    ...
    def edit_config_fields(self):
        ...
        lbl_lora.grid(row=3, column=0, columnspan=2, sticky="w", pady=(8, 2))
        popup_labels.append((lbl_lora, "edit_lora"))

        lc = config.get("local_config", {}) or {}
        lora = lc.get("lora", {}) or {}
        vregion = mk_label(4, "edit_region", _region_label_from_int(lora.get("region", 0)))
        vmodem = mk_label(5, "edit_modem", _modem_label_from_int(lora.get("modem_preset", 0)))

        lbl_channels = ttk.Label(frm, font=("Arial", 9, "bold"), foreground="#333")
        lbl_channels.grid(row=6, column=0, columnspan=2, sticky="w", pady=(8, 2))
        ...
        vch0 = mk_label(7, "edit_ch0", _get_ch_name(0))
        vch1 = mk_label(8, "edit_ch1", _get_ch_name(1))

        lbl_psk = ttk.Label(frm, font=("Arial", 8), foreground="#888")
        lbl_psk.grid(row=9, column=0, columnspan=2, sticky="w")
