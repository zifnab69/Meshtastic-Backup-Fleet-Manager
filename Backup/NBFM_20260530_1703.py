...
import os, sys, threading, json, shutil, copy, time, re
...
def _coerce_repeated_fields(section_data: dict, proto_obj) -> dict:
    """Convertit en liste toute valeur scalaire pour un champ repeated protobuf.
    Nécessaire car certaines versions de MessageToDict sérialisent un champ repeated
    vide en 0 au lieu de [], provoquant l'échec de ParseDict (ex : ignore_incoming)."""
    try:
...
# Panneau Editer champs clés Taille
        ...
        # espaceur entre override_freq et rôle
